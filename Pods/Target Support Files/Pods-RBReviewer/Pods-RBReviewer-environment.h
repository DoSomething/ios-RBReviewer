...
// SlothKit
#define COCOAPODS_POD_AVAILABLE_SlothKit
#define COCOAPODS_VERSION_MAJOR_SlothKit 0
#define COCOAPODS_VERSION_MINOR_SlothKit 1
#define COCOAPODS_VERSION_PATCH_SlothKit 0
